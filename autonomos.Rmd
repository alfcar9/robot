...
```{r, cache=TRUE}
resol <- 30   # recomiendo 10, 20, 30, ...etc Es el tamaño de la imagen reducida en porcentaje. 10% de la imagen original, por ejemplo.
path <- "../images/imgs/"
file.names <- dir(path)
...
nrow <- 480*resol/100
ncol <- 640*resol/100
path_csv <- "/home/egranadoo/Dropbox/ITAM.Gary/Maestria/1 Semestre/aprendizaje_maquina/autonomos/robot/imgs-eval.csv"
